...
**Engenheiro de Dados | Estudante de Sistemas de informação na UFPA** - Castanhal, Pará, Brasil

> 👋 Engenheiro de Dados com 8 meses de experiência em explorações e soluções de engenharia e análise de dados utilizando Python, SQL e AWS, e mergulhando em ferramentas como PySpark e Docker para otimizar o processamento de dados e pipelines de ETL.

### **Meus Contatos**
[📧 Email Pessoal](mailto:nycolasmiguel777@gmail.com)
|
[🔗 Linkedin](https://www.linkedin.com/in/nycolas-bastos-155592222/) |
[👾 Portifólio (Github)](https://github.com/TrInfra) 

## Experiência

### **Engenheiro de dados e desenvolvedor back-end** | setembro 2024 - presente
*Link Jr* | *Link JR*

🌎 *Híbrido, Pará, Brasil*

- Criação de data lakes, ETL, análise de dados e consumo de APIs;
- Criação de CRUDs, APIs, comunição entre sistemas front-end e back-end.
...
## Educação
### **Tecg.o em Análise e Desenvolvimento de Sistemas**

*UNOPAR | Universidade Pitágoras Unopar Anhanguera*

🌎 Castanhal, Pará, Brasil | março 2021 - Dezembro 2023

### **B.SI em Sistemas de informação**

*UFPA | Universidade Federal Do Estado Do Pará*

🌎 Castanhal, Pará, Brasil | Agosto 2022 - Setembro 2026

## Certificações

*AWS Certified Cloud Practitioner 2024 CLF-C02*  
